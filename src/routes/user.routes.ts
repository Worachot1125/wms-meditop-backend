...
import {
  ...
  updateUserPin,
  deleteUser,
  getAdjustmentApprovers,
  verifyAdjustmentApproverPin,
...
router.get("/adjustment-approvers", getAdjustmentApprovers);
router.post("/verify-adjustment-approver-pin", verifyAdjustmentApproverPin);
